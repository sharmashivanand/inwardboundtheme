<?php
/**
 * Related Events Template (Theme Override)
...
<ul class="tribe-related-events tribe-clearfix">
	...
	<li>
		...
		<div class="tribe-related-events-thumbnail">
			<a href="<?php echo esc_url( tribe_get_event_website_url( $post ) ); ?>" class="url" rel="bookmark" tabindex="-1"><?php echo $thumb ?></a>
		</div>
		<div class="tribe-related-event-info">
			<h3 class="tribe-related-events-title"><a href="<?php echo tribe_get_event_website_url( $post ); ?>" class="tribe-event-url" rel="bookmark"><?php echo get_the_title( $post->ID ); ?></a></h3>
			<?php
